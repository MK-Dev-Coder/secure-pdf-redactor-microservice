...
ipcMain.handle('redact-text', async (event, text) => {
    try {
        // Note: In a distributed environment, service discovery (e.g., Consul) should be used to resolve the backend URL.
        // Using default local endpoint for development configuration.
